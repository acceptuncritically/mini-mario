...
| TC-LVL-06 | 内置 `LEVELS` | 校验 | 长度 = 1；17 行 × 200 列；恰好 1 个 P、1 个 F；敌人 ≥ 6、金币 ≥ 25、**钉刺 ≥ 20（10~12 组）**、中途检查点 = 2 |
| TC-LVL-07 | 内置 `LEVELS`（v2.1 双路） | 校验 | 中段 col 75~120 存在 ≥12 个平台列（第 11~12 行 `#`）；**所有平台列第 14 行无敌人**；第 10 行（上路金币）在 75~120 内 ≥6 个 |
